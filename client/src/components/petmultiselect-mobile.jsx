...
const PetMultiSelectMobile = ({ items, selectedItems, setSelectedItems, maxSelected }) => {
  ...
  return (
    <div ref={dropdownRef} className="relative w-full">
      <button
        ...
        className={`w-full h-10 bg-bg4 rounded-md px-4 py-2 font-mono text-left cursor-pointer leading-none border-2 ${dropdownOpen ? "border-primary" : "border-transparent"
          } text-textMuted truncate`}
        //style={{ height: "40px" }}
        type="button"
      >
        {selectedItems.length === 0
          ? `Select up to ${maxSelected} pets...`
...
export default PetMultiSelectMobile;